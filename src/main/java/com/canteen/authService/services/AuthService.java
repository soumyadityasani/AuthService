...
import com.canteen.authService.enums.MessagesEnum;
import com.canteen.authService.exceptions.EmailSendFailException;
import com.canteen.authService.exceptions.RoleNotFoundException;
import com.canteen.authService.exceptions.UserNotFoundException;
import com.canteen.authService.repo.PendingEmailRepo;
...
public class AuthService {
    ...
    public ResponseEntity<ApiResonseDto<LoginResponseDto>> loginUser(LoginRequestDto requestDto) {
            ...
            ApiResonseDto<LoginResponseDto> resonseDto=ApiResonseDto.<LoginResponseDto>builder()
                    ...
                    .data(new LoginResponseDto(token,user.getRole().name()))
                    .timeStamp(LocalDateTime.now())
                    .build();
